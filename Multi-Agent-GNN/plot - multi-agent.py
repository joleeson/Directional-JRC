...
#    args = parser.parse_args()
    ...
    args.logdir_rotation = (
        'data/testvg_env_radinterval4_beamform_JRC_multi_vi_26-01-2022_17-24-16_8usrs_rotate_wcomm11.0_w_rad6.0_maxage_8.0_ang45.0 - Copy', # 7k iterations, entropy decay up to 5k itr
        )
    
    args.logdir_heuristic = (
        'data/testvg_beamform_JRC_multi_vi_26-01-2022_17-25-06_8usrs_heuristic_wcomm11.0_w_rad6.0_maxage_8.0_ang45.0 - Copy',   # 7k iterations, entropy decay up to 5k itr
        )

    args.logdir_PPO_GCN = (
        'data/A2C_SNR_GCN_bs1200_n7000_beamform_JRC_multi_vi_31-01-2022_21-34-52_8users_wcomm1.0_w_rad6.0_maxage_8.0_ang45.0_obtimeTrue',               # 7k iterations, entropy decay up to 5k itr
        'data/PPO_SNR_GCN_0NN_bs1200_n7000_beamform_JRC_multi_vi_31-01-2022_21-34-56_8users_wcomm1.0_w_rad6.0_maxage_8.0_ang45.0_obtimeTrue',
        'data/PPO_SNR_GCN_bs1200_n7000_beamform_JRC_multi_vi_31-01-2022_21-35-28_8users_wcomm1.0_w_rad6.0_maxage_8.0_ang45.0_obtimeTrue',
        'data/PPO_8NN_GCN_GRU_bs1200_n7000_beamform_JRC_multi_vi_31-01-2022_21-35-03_8users_wcomm1.0_w_rad6.0_maxage_8.0_ang45.0_obtimeTrue',
        'data/PPO_8NN_GCN_IC3_bs1200_n7000_beamform_JRC_multi_vi_31-01-2022_21-34-59_8users_wcomm1.0_w_rad6.0_maxage_8.0_ang45.0_obtimeTrue',
        'data/PPO_SNR_Attn_bs1200_n7000_beamform_JRC_multi_vi_31-01-2022_21-34-58_8users_wcomm1.0_w_rad6.0_maxage_8.0_ang45.0_obtimeTrue',
        'data/PPO_8NN_Attn_IC3_bs1200_n7000_beamform_JRC_multi_vi_03-02-2022_23-44-13_8users_wcomm1.0_w_rad6.0_maxage_8.0_ang45.0_obtimeTrue',
        'data/PPO_8NN_Attn_GRU_IC3_bs1200_n7000_beamform_JRC_multi_vi_31-01-2022_21-35-23_8users_wcomm1.0_w_rad6.0_maxage_8.0_ang45.0_obtimeTrue',
        )
    
    args.logdir = args.logdir_rotation + args.logdir_heuristic + args.logdir_PPO_GCN                                           # multi-agent problem
    
    """ Legend """
    args.legend = [r'Round Robin', r'Heuristic', r'A2C - GCN', r'Independent PPO', r'PPO - GCN', r'PPO - GCN + GRU', r'PPO - GCN + IC3', r'PPO - GANN', r'PPO - GANN + IC3', r'PPO - GANN + IC3 + GRU']
